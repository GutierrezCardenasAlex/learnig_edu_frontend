...
export default function EnrolledCourses() {
  ...
  return (
    <>
      <div className="text-4xl text-richblack-5 font-boogaloo text-center sm:text-left">Cursos matriculados</div>
      {
        <div className="my-8 text-richblack-5">
          {/* Headings */}
          <div className="flex rounded-t-2xl bg-richblack-800 ">
            <p className="w-[45%] px-5 py-3">Nombre Curso</p>
            <p className="w-1/4 px-2 py-3">Duración</p>
            <p className="flex-1 px-2 py-3">Progreso</p>
          </div>
              ...
              >
                ...
                <div className='sm:hidden'>
                  ...
                  <div className="flex sm:w-2/5 flex-col gap-2 px-2 py-3">
                    ...
                    <p>Progreso: {course.progressPercentage || 0}%</p>
                    <ProgressBar
